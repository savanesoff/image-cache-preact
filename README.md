...
[![npm version](https://badge.fury.io/js/image-cache-preact.svg)](https://badge.fury.io/js/image-cache-preact)
...
[![Validator](https://raw.githubusercontent.com/savanesoff/image-cache-pro/main/demo-assets/image-cache-demo.gif)](https://savanesoff.github.io/image-cache-preact)

[![NPM](https://nodei.co/npm/image-cahce-pro.png?downloads=true&downloadRank=true&stars=true)](https://nodei.co/npm/image-cache-preact/)
...
`image-cache-preact` library provides the following features:
...
`image-cache-preact` library provides a way to monitor the RAM usage of the images loaded by the application. This is useful to ensure that the application does not consume too much memory and slow down the system.
